...
vim.keymap.set("n", "<leader>ma", require("harpoon.mark").add_file, {desc= "[h]arpoon [a]dd file"})
vim.keymap.set("n", "<leader>ms", require("harpoon.ui").toggle_quick_menu, {desc= "[h]arpoon [s]how files"})
